                ...
                <div class="card shadow-lg">
                    <div class="card-body">
                        <div class="card-title">
                            <h1 class="text-center title-2 py-3 rounded-3 shadow-sm fw-bold" style="font-size:1.5rem; border:1px solid #ddd;">{{Auth::user()->name}} Profile
                            </h1>
                        </div>
                        <hr>
                        <form action="{{route('admin#update',Auth::user()->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-5">
                                    ...
                                    <div>
                                        <input type="file" name="image" class="form-control my-3 @error('image') is-invalid  @enderror">
                                        @error('image')
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" id="address" class="form-control" cols="30" rows="5" placeholder="Enter Address" value="">{{ old('address',Auth::user()->address) }} </textarea>
                                        @error('address')
                                        <small class="invalid-feedback"> {{ $message }} </small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="test" name="role" class="form-control" value=" {{ old('role',Auth::user()->role)  }} " disabled>
                                    </div>
                                </div>
                        </form>
                    </div>
