...
<body class="animsition position-relative">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__item logout" style="background:rgba(0,0,0,0.5);">
                                                    <form action=" {{ route('logout') }} " method="POST">
                                                        @csrf
                                                        <button type="submit"
                                                            class="p-1 m-2 text-dark col-11"><i
                                                                class="zmdi zmdi-power mx-2"></i>Logout</button>
                                                    </form>
                                            </div>
                                        </div>
                                    </div>
