        ...
        <form action=" {{ route('register') }} " method="post" class="row">
            ...
            <div class="col-6">
                ...
                <div class="form-group">
                    ...
                    <select name="gender" id="" class="au-input au-input--full py-2" style="background: transparent;">
            ...
            <div class="col-6">
                <div class="form-group">
                    <label>Address</label>
                    <textarea class="au-input au-input--full" type="text" rows="3" name="address" placeholder="Address"></textarea>
                    @error('address')
                    <small class="text-danger"> {{ $message }} </small>
                    @enderror
                </div>
            ...
            <div class="register-link m-auto py-2">
                <p>
