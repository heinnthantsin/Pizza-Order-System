            ...
            <div class="h-100 bg-light p-30">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    <div class="input-group quantity mr-3" style="width: 140px;">
                        ...
                        <input type="text" class="form-control border-0 text-center px-2" value="1" id="orderCount">
                ...
                <a href="{{ route('user#homePage') }}" class="btn btn-dark mt-3 rounded"><i class="fa-solid fa-arrow-left me-2"></i>Back</a>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="product-item bg-light">
                        <div class="product-img position-relative overflow-hidden" style="height: 200px">
                            ...
                            <div class="product-action">
                                <a class="btn btn-outline-dark btn-square mx-3" href=""><i class="fa fa-shopping-cart"></i></a>
                                <a class="btn btn-outline-dark btn-square" href="{{ route('user#details',$p->id)}}"><i class="fa-solid fa-info-circle"></i></a>
                            </div>
                        </div>
